...
<head>
    ...
    <c:set var="registerFlag" value="${empty drinkVO.id ? 'create' : 'modify'}"/>
    ...
    <validator:javascript formName="drinkVO" staticJavascript="false" xhtml="true" cdata="false"/>
    
    <script type="text/javaScript" language="javascript" defer="defer">
        <!--
        /* 글 목록 화면 function */
        function fn_egov_selectList() {
           	document.detailForm.action = "<c:url value='/drinkList.do'/>";
           	document.detailForm.submit();
        }
        
        /* 글 삭제 function */
        function fn_egov_delete() {
           	document.detailForm.action = "<c:url value='/deleteDrink.do'/>";
           	document.detailForm.submit();
        }
        ...
        function fn_egov_save() {
        	...
        	if(!validateDrinkVO(frm)){
                return;
            }else{
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/addDrink.do' : '/updateDrink.do'}"/>";
                frm.submit();
            }
        }
...
<form:form commandName="drinkVO" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
    ...
    <!-- 검색조건 유지 -->
    <input type="hidden" name="searchCondition" value="<c:out value='${findVO.searchCondition}'/>"/>
    <input type="hidden" name="searchKeyword" value="<c:out value='${findVO.searchKeyword}'/>"/>
    <input type="hidden" name="pageIndex" value="<c:out value='${findVO.pageIndex}'/>"/>
</form:form>
</body>
</html>